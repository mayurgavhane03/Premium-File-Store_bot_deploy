...
from bot import Bot
from config import ADMINS, FORCE_MSG, OWNER_TAG, START_MSG, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, PROTECT_CONTENT, OWNER_ID, CHANNEL_LINK,CUSTOM_ADDED_CAPTION
from helper_func import subscribed, decode, get_messages, removeDuplicates
...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        for msg in messages:
            ...
            # Adding the additional text to the caption
...
async def add_admin(client: Bot, message: Message):
    ...
    try:
        ...
        await client.send_message(
            chat_id=user_id,
            text=f"You are verified, join the channel and check out the pinned message inside the channel about how to use this bot.",
            reply_markup=reply_markup
        )
