...
async def add_admin(client: Bot, message: Message):
    ...
    try:
        ...
        await message.reply("User have been added as an admin.")
        await client.send_message(
            chat_id=user_id,
            text=f"You are verified join the channel Check out pinned message inside the channel about how to use this bot.",
            reply_markup=reply_markup
        )
